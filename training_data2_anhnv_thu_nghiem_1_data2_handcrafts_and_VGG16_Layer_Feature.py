    ...
    for category in categories:
        ...
        for layer in layers:
            layer_path = os.path.join(
                feature_dir, f"{dataset_type}/layer_deep_and_handcrafts_and_vgg16_feature/{category}/{layer}"
            )
...
def main():
    ...
    feature_dir = os.path.join(home_dir, 'data2_handcrafts_and_VGG16_Layer_Feature')
    result_dir = os.path.join(home_dir, 'training_data2_anhnv_thu_nghiem_1_data2_handcrafts_and_VGG16_Layer_Feature')
