...
def main():
    ...
    home_dir = os.getcwd()
    data_dir = os.path.join(home_dir, 'data1')
    
    data_input_dir = os.path.join(data_dir, 'data1_HIEN_SPLIT')
    ...
    labels = ['BCC', 'MM', 'SCC', 'no skin cancer']

    # Tạo các thư mục đầu ra
    feature_output_dir = os.path.join(data_dir, 'data1_SOTA_and_handcrafts_and_BlookNet_optimal_entropy_features')
    ...
    stats_output_file = os.path.join(feature_output_dir, "layer_wise_label_statistics.txt")
